...
#ifndef CLASSIFIERS_TREES_RANDOMIZEDTREETEST_HPP_
#define CLASSIFIERS_TREES_RANDOMIZEDTREETEST_HPP_
 ...
 * RandomTreeTest
 */
class RandomizedTreeTest: public BaseTest {
public:
...
#endif /* CLASSIFIERS_TREES_RANDOMIZEDTREETEST_HPP_ */
